...
function Movie(props) {
  ...
  const yseterday = year + "-" + month + "-" + date;

  // 도착한 1~10위 정보 화면에 보여주기
  ...
  return (
    <div>
      <Container className="mt-5">
        <Row>
          <Col xs={10}>
            <Button className="mb-2" variant="outline-primary" onClick={rank}>
              영화 순위 가져오기
            </Button>
          </Col>
          <Col>
            <input type="date" className="form-control" value={yseterday} />
          </Col>
        </Row>
        {displayData}
      </Container>
